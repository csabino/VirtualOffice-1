      ...
      function run_file_upload(file_type, property){
            ...
            if (image_size>20000){
                alert("The file is larger than the allowed 20MB size. Please resize and try again.");
                    ...
                    $.ajax({
                        url: '../../async/server/file_upload/task_upload_file.php?source=tasks&file_type='+file_type,
                        method: "POST",
                        data: form_data,
                        dataType:  'json',
                        contentType: false,
...
// Remove file
    $("#activity_notifier").on("click", "span#deletefile", function(){
        ...
        $.post("../../async/server/task/remove_uploaded_file.php",function(data){
              $("#myuploadedfile").remove();
        });
    });
