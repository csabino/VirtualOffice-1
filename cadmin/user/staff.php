    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 page_header_spacer">
                <h3>Staff (<?php echo $number_of_users; ?>)</h3>
            </div>
        ...
        <div class="row">
            <!-- Create Cell Button //-->
            <?php
                $create_staff_link = "create_user.php?ut=".mask("s");

             ?>
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 mt-2 text-right">
                  <a href="<?php echo $create_staff_link; ?>" class="btn btn-primary btn-sm btn-rounded color_scheme_opacity" > <i class="far fa-user" aria-hidden="true"></i> Create Staff</a>
                  <a href="upload_staff.php" class="btn btn-primary btn-sm btn-rounded color_scheme_opacity" > <i class="fas fa-users" aria-hidden="true"></i> Upload Staff</a>
                  <a href="user_roles.php" class="btn btn-primary btn-sm btn-rounded color_scheme_opacity" > <i class="fas fa-users" aria-hidden="true"></i> Roles</a>
                  ...
                  <tbody id='tblBody'>
                      <?php
                          ...
                          foreach($get_users as $row){
                             ...
                             // Button cell edit
                             $mask = mask($user_id);
                             $user_edit_link = "user_edit.php?q={$mask}";
                             ...
                             $btn_user_delete = "<a href='{$user_delete_link}'
                              ...
                              echo "<tr>";
                              echo "<td width='5%'>{$counter}.</td><td>{$user_title} {$user_firstname} {$user_lastname}</td>
