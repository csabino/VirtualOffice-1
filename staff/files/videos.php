  ...
  <div class="container">
      ...
      <div class="row mt-5">
              <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 mb-3 text-info font-weight-bold" >
                    <big><i class="fas fa-video"></i> Videos </big>
              </div>
              <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-right">
                    <?php
                        ...
                        $new_memo_link = "new_video.php?q=".$code1;

                    ?>
                    <a href="<?php echo $new_memo_link; ?>" class="btn btn-sm btn-primary btn-rounded"> <i class="fas fa-plus"></i>&nbsp; New Video</a>
              </div>
