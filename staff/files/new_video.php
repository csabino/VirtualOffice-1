  ...
  <div class="container">
      ...
      <div class="row mt-5">
              <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 mb-3 text-info font-weight-bold" >
                    <big><i class="fas fa-video"></i> Upload Video</big>
              </div>
              <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6 text-right">
                    <?php
                        ...
                        $memo_list_link = "videos.php?en=".$code1;

                    ?>
                    <a href="<?php echo $memo_list_link; ?>" class="btn btn-sm btn-primary btn-rounded"> <i class="fas fa-chevron-left"></i>&nbsp; Videos</a>
              </div>
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        ...
                        <form class="border border-light p-4 " style="border-radius:5px;"
                          ...
                          method="post">
                            ...
                            <!-- File Type  -->
                            <div>
                              <label for="file_upload" class="text-info font-weight-normal mt-2">Upload Video<span class='text-danger'></span></label>
                            </div>
                            <!-- Default inline 1-->
                            <div class="custom-control custom-radio custom-control-inline">
                              <input type="radio" class="custom-control-input" id="file_upload_type_video" name="file_upload_type"  value="video" <?php if(isset($_POST['btnSubmit'])){ if(!$errFlag){echo "unchecked";} } ?> >
                              <label class="custom-control-label" for="file_upload_type_video">Video</label>
                            </div>
...
<?php
 ...
 ?>
<script src="../../async/client/file/upload_video.js"></script>
